...
@interface InterestingPlacesTableViewController ()

@end

@implementation InterestingPlacesTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text=[self.city.interestingPlaces[indexPath.row] description];
